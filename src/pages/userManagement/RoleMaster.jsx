...
import RoleMasterForm from "../../component/useManagement/roleMaster/RoleMasterForm";
import RoleMasterTable from "../../component/useManagement/roleMaster/RoleMasterTable";
import { GetAllRolesAPI } from "../../service/Api";
import { useData } from "../../context/DataProvider";
import { useAuth } from "../../context/AuthProvider";
import { exportToExcel } from "../../../utils/ExportUtils";

const RoleMaster = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const handleExport = () => {
    ...
    exportToExcel(dataToExport, "RoleMasterData", "Roles");
  };
            ...
            <div className="relative w-full max-w-xs">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-full pl-10 pr-4 py-2 text-sm
                  ...
                  focus:border-purple-500 focus:outline-none transition-all duration-150"
              />
            </div>
