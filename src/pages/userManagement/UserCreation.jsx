...
import UserCreationForm from "../../component/useManagement/userCreation/UserCreationForm";
import UserCreationTable from "../../component/useManagement/userCreation/UserCreationTable";
...
const UserCreation = () => {
  ...
  //     setIsLoading(true);
  //     try {
  //       const data = await getUserCreationAPI();
  //       setRaw(data.data || []);
  //     } catch (error) {
  //       console.error("Error fetching data:", error);
  //     } finally {
  ...
  const handleExport = () => {
    ...
    exportToExcel(dataToExport, "UserCreationData", "Users");
  };
          ...
          <div className="flex items-center justify-between gap-4 w-full flex-wrap">
            ...
            <div className="relative w-full max-w-xs">
              ...
              <input
                ...
                bg-white text-gray-900  focus:ring-3 focus:ring-purple-200 
                focus:border-purple-500 focus:outline-none ansition-all duration-150"
              />
            </div>
            ...
            <div className="flex items-center gap-6 w-full md:w-auto sm:justify-start">
              ...
              {isFormVisible && rights?.rights_Insert && (
                <button
